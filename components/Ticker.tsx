...
export function Ticker({
  ...
  const anim = duration
    ? `gf-marquee ${duration}s linear infinite`
    : "gf-marquee var(--ticker-duration) linear infinite";
  const span: CSSProperties = { paddingRight: 48, whiteSpace: "nowrap" };
  return (
    <div style={{ borderTop: border, borderBottom: border, overflow: "hidden", padding: "8px 0" }} aria-hidden>
      <div
        className="gf-marquee-track"
        style={{
          display: "flex",
          width: "max-content",
          animation: anim,
